...
export const getServerSideProps = async () => {
  try {
    const response = await (await axiosInstance.get("hockey/fetchfreepred")).data
...
const Hockey: NextPage = ({FirstLeague,FirstFixtures,error}:any) => {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.headDiv}>
          ...
          <div className={`${styles.mainDiv} card`}>
            ...
            <HockeyMobile League={League} Fixture={Fixture} Loading={Loading}/>
            </div>
            ...
            {Loading === true? <div style={{textAlign:'center'}}> <span><Spinner animation="border"/>&nbsp;&nbsp;<span>Loading...</span></span></div> :
             ...
             League?.map((data:any,i:any)=>(
              ...
              <div className={styles.hockeycountry}><Image style={{marginTop:'-4px',marginRight:'10px'}} src={data.flag? data.flag : "/images/fifa.png"} width={20} height={13} alt='accesspredict'/>
